...
BAD_WORDS = {"нахуй" "e","уёбок","уёбище","сука", "уебок", "хуй", "пидр", "пидор","пидорас","долбаеб","долбаёб","пох","похуй","хуесос","бля","блять","бл","блат","блят","уебан","ебан","ебать","еблан","хуела","ебаное","член","заебал","сосать","сосо"}
